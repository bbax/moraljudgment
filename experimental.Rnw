...
\begin{figure}[htb]
    \caption[Compromise Balance]{\textbf{Percentage of Respondents Wanting the In-Party to Receive at Least 75 percent of its Agenda in a Compromise}\\
    ...
    \centering
    {\includegraphics[width=.48\textwidth]{pairwise_compromise_Immoral_v_Incomp-1.pdf}}
\end{figure}
